...
Interpreter.prototype.initGlobal = function (globalObject) {
    ...
    this.setProperty(globalObject, 'this', globalObject, Interpreter.READONLY_DESCRIPTOR);
...
Interpreter.prototype.nativeToPseudo = function (nativeObj) {
    ...
    if (typeof nativeObj === 'object' && nativeObj.hasOwnProperty('_s8async')){
        return this.createAsyncFunction(nativeObj.run);
    }
...
Interpreter.prototype['stepBinaryExpression'] = function (stack, state, node) {
    ...
    switch (node['operator']) {
        ...
        case 'instanceof':
            ...
            value =
                leftValue instanceof Interpreter.Object ? this.isa(leftValue, rightValue) : false;
            break;
        default:
        ...
        gotPropName: while (true) {
            if (state.object_ instanceof Interpreter.Object) {
                ...
                while (true) {
                    ...
                    if (
                        !Object.prototype.propertyIsEnumerable.call(state.object_.properties, prop)
                    ) {
